const DATA = {
  ...
  foto: "https://avatars.githubusercontent.com/sadteams", // INI FOTO PROFILE GITHUB KAMU
  ...
  tech: [
    ...
    {name: "JavaScript", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/javascript/javascript-original.svg"}, // FIX LINK JS
    {name: "WhatsApp", icon: "https://cdn.jsdelivr.net/npm/simple-icons@v11/icons/whatsapp.svg"} // FIX LINK WA
  ],
  projects: [
