...
async function fetchAllProjects(){ 
  ...
  projectsContainer.innerHTML = allRepos.map(p => `<div class="glass-card"><img src="${p.img}" class="project-img" onerror="this.src='https://images.unsplash.com/photo-1555066931-4365d14bab8c?w=600'"><h3>${p.title}</h3><p style="color:var(--muted);margin:1rem 0">${p.desc}</p><a href="${p.link}" target="_blank" class="magnetic-btn">View Code</a></div>`).join(''); 
  magneticButtons(); 
}
