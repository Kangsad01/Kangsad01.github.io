...
const DATA = {
  ...
  projects: [
    {
      title: "PORTFOLIO V3",
      desc: "Portfolio personal dengan animasi GSAP, dark mode, dan responsive design. 100% Vanilla JS.",
    ...
    },
    {
      ...
      desc: "Admin dashboard modern dengan chart real-time, dark mode, dan CRUD lengkap.",
    ...
    },
    {
      ...
      desc: "Landing page untuk produk SaaS dengan animasi scroll-trigger dan form terintegrasi.",
  ...
  testimonials: [
    {name: "Client A", job: "CEO Startup", text: "Website nya keren banget. Animasi nya smooth.", avatar: "https://i.pravatar.cc/100?img=1"}
  ],
...
function injectCSS(){
 ...
 .project-img{width:100%;height:250px;object-fit:cover;border-radius:15px 15px 0 0}
 ...
 .tech-card{padding:2rem;text-align:center}
