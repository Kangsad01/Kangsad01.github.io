const DATA = {
  nama: "Kangsad01",
  github: "sadteams", // ganti ke sadteams biar statsnya bener
  role: ["WhatsApp Bot Developer", "Backend Engineer", "Creative Coder"],
  about: "Aku suka bikin bot dan tools yang bener-bener dipake orang. Fokus di automation, database, dan UI yang clean.",
  foto: "https://avatars.githubusercontent.com/u/88497118?s=96&v=4", // GANTI PAKE FOTO KAMU
  ...
  tech: [
    ...
    {name: "WhatsApp API", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/whatsapp/whatsapp-original.svg"}
  ],
  projects: [
    {
      title: "WEABOT - WA BOT", 
      desc: "Bot WhatsApp multi-fitutr dengan menu interaktif, sticker, dan game. Dibangun pake Node.js + Baileys.", 
      img: "https://images.unsplash.com/photo-1611162617474-5b21e879e113?w=600",
      link: "https://github.com/sadteams/Weabot/tree/update"
    },
    {
      title: "DATABASE SYSTEM", 
      desc: "Sistem database untuk menyimpan data user, premium, dan log bot. Support MongoDB & JSON.", 
      img: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=600",
      link: "https://github.com/sadteams/database"
    },
    {
      title: "PORTFOLIO WEBSITE", 
      desc: "Website portfolio personal dengan efek glassmorphism, particle cursor, dan animasi liquid.", 
...
function injectCSS(){
 ...
 .typing-cursor{display:inline-block;width:4px;height:2rem;background:var(--accent);animation:blink 1s infinite;margin-left:5px}
...
function Projects(){ 
  const projectHTML = DATA.projects.map(p => `
    <div class="project-card glass-card">
      ...
      <p style="color:var(--muted);font-size:1.1rem;margin-bottom:1.5rem">${p.desc}</p>
